...
export const Badge = ({
  ...
  return (
    <div
      className={`whitespace-nowrap capitalize inline-flex items-center justify-center gap-1.5 px-${padding} rounded-md bg-${backgroundColor} border border-${borderColor} min-h-6 max-h-6 ${className}`}
    >
